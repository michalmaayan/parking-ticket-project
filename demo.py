...
def address_to_coordinate(address):
	...
	try:
		...
		messagebox.showinfo('Message title', 'Invalid Street name, Enter a valid street name')
		pass
...
def zone_csv_file(day, global_zone):
	...
	if day == 0 or day == 6:
		...
		start_title = "weekday"
	path_name = r"C:\Users\Tehilah\Desktop\parkingData\zones\\" + start_title + "_zone_time" + global_zone + ".csv"
	return path_name
...
def run_demo(day, time, street_name):
	try:
		...
		training_data = pd.read_csv(r"C:\Users\Tehilah\Desktop\parkingData\geoUnited2016.csv")
